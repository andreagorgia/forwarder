...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1621773184:AAHalphRUvFaWIXXja-hcPXijQZOpvuDTrs"  # API key obtained from BotFather
    OWNER_ID = "567980459"  # If you dont know, run the bot and do /id in your private chat with the bot

    # FOR AUTOMATICALLY FORWARDING MESSAGES
    FROM_CHATS = [-1001234704297 ]  # List of chat id's to forward messages from
    TO_CHATS = [-413690652]  # List of chat id's to forward messages to
